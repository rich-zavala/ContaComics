        ...
        return [
            ...
            function(
                ...
                for (var i = 0, l = webStorage.length, k; i < l; i++) {
                    ...
                    (k = webStorage.key(i)) && 'ngStorage-' === k.slice(0, 10) && ($storage[k.slice(10)] = JSON.parse(webStorage.getItem(k), dateReviver));
										// c($storage[k.slice(10)]);
                }
                ...
                'localStorage' === storageType && $window.addEventListener && $window.addEventListener('storage', function(event) {
                    if ('ngStorage-' === event.key.slice(0, 10)) {
                        ...
                        event.newValue ? $storage[event.key.slice(10)] = JSON.parse(event.newValue, dateReviver) : delete $storage[event.key.slice(10)];
